	...
	*/
		function buildPanels() {
			...
			j_panels.each(function(i){
				...
				var pid = imgsrc.substr(
							imgsrc.lastIndexOf("_") + 1, imgsrc.lastIndexOf(".") - imgsrc.lastIndexOf("_") - 1
						);
				img.wrap("<div id='p_" + pid + "' class='link-container'><a href='http://apps.facebook.com/imissu_dev/user/" + opts.name + "/photo/" + pid + "' target='_top' /></div>");
			});
